...
executiveSummary: "What a motel manager does day-to-day: the five core responsibilities, skills required, lifestyle realities, and how to prepare before applying for your first role. If your a Motel Owner looking for support in [Motel Management](/motel-management/)"
---
...
<div class="border-2 border-dashed border-[#4A554E] rounded-2xl p-8 my-10">
  ...
  <form action="https://hooks.zapier.com/hooks/catch/26131104/upwyerc/" method="POST" class="flex flex-col sm:flex-row gap-3 global-download-form" data-download="/downloads/how-to-run-a-motel.pdf">
