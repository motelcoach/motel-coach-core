...
> As we highlighted in an op-ed for [Accom News](https://www.accomnews.com.au/2026/03/op-ed-a-day-in-the-life-of-a-motel-manager/), the catch with on-site living is that you are always at work. You are continuously on call—and even when you aren't on duty, you're mentally waiting for the night bell or front desk phone to ring.
...
When a passive investor replaces that dedicated owner with a salaried manager, operating costs often creep up and service standards can slip. If standards fall, occupancy drops—and profit margins shrink fast. [Hiring the right motel manager](/motel-manager-recruitment/) and putting in place the right daily and weekly checks makes a big difference to your motel earnings.
...
- **Understanding Yields Simple Math Example:**
  1. **Gross Yield**, a basic approach that looks at top-line revenue before expenses like utilities, labour and insurance. **Calculation** = Total Room Revenue / Motel Purchase Price.
  2. **Capitalization Rate**, Cap Rate or Net Yield = The gross revenue less all of your operating expenses, it excludes mortgage payments, income taxes and depreciation. **Calculation** = Net Operating Income (NOI) / Purchase Price.
  3. **Cash-on-Cash Return or Leveraged Yield** = the return you get on the money you put in, it accounts for all costs pre-tax, including mortgage payments. Calculation = Annual Pre-Tax Cash Flow / Purchase Price.
  4. **Net Operating Income (NOI)** = What the business generates in profit, without accounting for borrowing costs. 
  5. **EBITDA**, Earnings Before Interest Tax Depreciation and Amortisation.
  6. **PEBITDA**, is a metric used to value small-to-medium businesses by adding the owner's wage and personal expenses back into the net profit.
...
A focused session on your existing motel asset or a prospective motel investment. Normally $259 — only $135.
